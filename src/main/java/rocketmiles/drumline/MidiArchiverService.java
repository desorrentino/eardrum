...
/**
 * A service that records and archives recorded data on all input midi devices.
 * New devices are detected using a periodic check.
 */
public class MidiArchiverService implements AutoCloseable {
	...
	public MidiArchiverService(final MidiSystemService midiSystemService,
	...
	private ArchivingReceiver startArchiverOnDevice(final MidiDevice midiDevice) throws MidiUnavailableException {
